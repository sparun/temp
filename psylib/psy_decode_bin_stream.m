...
% -------------------------------------------------------------------
% [param_table, params] = decode_bin_stream(data_stream)
% REQUIRED INPUTS
...
function [param_table, params] = psy_decode_bin_stream(data_stream)

global expt_str;
ss = expt_str.specs.iscan.sample_size;
...
nparams = expt_str.specs.iscan.max_params;
