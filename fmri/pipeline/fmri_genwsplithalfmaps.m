...
f = dir([subjfolder '/mats/*_wdnevt_betas.mat']);
...
f = dir([subjfolder '/mats/*_wdnevtmergedeven_betas.mat']);
load([subjfolder '/mats/' f.name]); evenbetas = betas;
f = dir([subjfolder '/mats/*_wdnevtmergedodd_betas.mat']);
...
save(sprintf('%s/mats/%s_wdnevtmerged_shmaps', subjfolder, subjectid), 'oeshcorrmap','oeshsigmap');
