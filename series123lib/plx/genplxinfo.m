function genplxinfo(plx_filespec, exptname)
global C;
dbstop if error;
delete('plxinfo.xls');
...
for file_id = 1:n_plx
    ...
    if length(nfiles) < prog_id, nfiles(prog_id,1) = 0; nunits(prog_id,1) = 0; end
    ...
    save('plxinfo', 'plxinfo', 'nfiles', 'nunits');
